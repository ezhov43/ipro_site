<?php ?>
        ...
        <div class="page-footer">
            <div class="page-footer-inner"> 2019 &copy; Ipro </div>
    ...
    <script src="<?= base_url() ?>assets/pages/scripts/charts-echarts.js" type="text/javascript"></script>
    
    <!-- END PAGE LEVEL SCRIPTS -->
    <!-- BEGIN THEME LAYOUT SCRIPTS -->
    <script src="<?= base_url() ?>assets/layout/scripts/layout.min.js" type="text/javascript"></script>
    <script src="<?= base_url() ?>assets/layout/scripts/demo.min.js" type="text/javascript"></script>
    <script src="<?= base_url() ?>assets/global/scripts/quick-sidebar.min.js" type="text/javascript"></script>
    <script src="<?= base_url() ?>assets/global/scripts/quick-nav.min.js" type="text/javascript"></script>
